...
void AES128_SR1_enc(AES128_STATE_t C0, AES128_STATE_t C1, AES128_STATE_t C2, AES128_STATE_t C3,	
...
void AES128_SR1_key_schedule_enc(uint64_t rk[AES128_BLOCK_NUM * 2 * (AES128_ROUNDS + 1)], const uint8_t mk[AES128_KEY_LEN]);
